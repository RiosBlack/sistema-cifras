...
async function main() {
  ...
  if (args.length < 3) {
    console.log(`
📝 Uso: npm run create-user <email> <nome> <senha> [role]

Exemplos:
  npm run create-user admin@exemplo.com "Admin" "123456" ADMIN
  npm run create-user user@exemplo.com "Usuário" "123456" USER
  npm run create-user user@exemplo.com "Usuário" "123456"
    `)
    process.exit(1)
  }
